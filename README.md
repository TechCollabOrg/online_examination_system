...
| 题目分类 | 给题目打标签分类，方便组卷         |
| 试题仓库 | 管理题目集合，按类别组织          |
| 考试管理 | 创建考试（设置时间、题目、分数、通过分线）；可开启**摄像头监考**与暂离规则；「查看详情」可预览试卷；启用监考的考试在列表中可点 **「监考」** 进入实时监考页 |
...
- 配置完成后点击 **「生成试卷题目」**：系统会按规则随机抽题并展示在下方列表中，可 **查看详情**、**设置分值**、**移除** 某题，或通过 **「从题库添加」** 补充题目；不满意可点 **「重新随机抽题」**
...
*最后更新：2026-05-19* · 监考详细配置见 [docs/PROCTOR_SETUP.md](docs/PROCTOR_SETUP.md)